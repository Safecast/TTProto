...
const pb_field_t ttproto_Telecast_fields[71] = {
    ...
    PB_FIELD( 14, FLOAT   , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, env_emperature, wireless_snr, 0),
    PB_FIELD( 15, FLOAT   , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, env_umidity, env_emperature, 0),
    PB_FIELD( 16, UINT32  , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, relay_device1, env_umidity, 0),
