...
const pb_field_t ttproto_Telecast_fields[71] = {
    PB_FIELD(  1, UENUM   , REQUIRED, STATIC  , FIRST, ttproto_Telecast, device_type, device_type, 0),
    PB_FIELD(  2, STRING  , OPTIONAL, CALLBACK, OTHER, ttproto_Telecast, DEPRECATED2017FEBDeviceIDString, device_type, 0),
    PB_FIELD(  3, UINT32  , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, DeviceID, DEPRECATED2017FEBDeviceIDString, 0),
    PB_FIELD(  4, STRING  , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, Message, DeviceID, 0),
    PB_FIELD(  5, STRING  , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, CapturedAt, Message, 0),
    PB_FIELD(  6, UENUM   , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, ReplyType, CapturedAt, 0),
    PB_FIELD(  7, UINT32  , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, DEPRECATED2017FEBValue, ReplyType, 0),
    ...
    PB_FIELD( 11, FLOAT   , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, BatteryVoltage, Altitude, 0),
    PB_FIELD( 12, FLOAT   , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, BatterySOC, BatteryVoltage, 0),
    PB_FIELD( 13, FLOAT   , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, WirelessSNR, BatterySOC, 0),
    PB_FIELD( 14, FLOAT   , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, envTemperature, WirelessSNR, 0),
    PB_FIELD( 15, FLOAT   , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, envHumidity, envTemperature, 0),
    PB_FIELD( 16, UINT32  , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, RelayDevice1, envHumidity, 0),
    PB_FIELD( 17, UINT32  , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, RelayDevice2, RelayDevice1, 0),
    PB_FIELD( 18, UINT32  , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, RelayDevice3, RelayDevice2, 0),
    PB_FIELD( 19, UINT32  , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, RelayDevice4, RelayDevice3, 0),
    PB_FIELD( 20, UINT32  , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, RelayDevice5, RelayDevice4, 0),
    PB_FIELD( 21, UINT32  , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, lnd_7318u, RelayDevice5, 0),
    ...
    PB_FIELD( 50, FLOAT   , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, envPressure, opc_csecs, 0),
    PB_FIELD( 51, UINT32  , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, stats_comms_power_fails, envPressure, 0),
    PB_FIELD( 52, FLOAT   , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, BatteryCurrent, stats_comms_power_fails, 0),
    PB_FIELD( 53, STRING  , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, stats_iccid, BatteryCurrent, 0),
    PB_FIELD( 54, UINT32  , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, stats_motiondrops, stats_iccid, 0),
    PB_FIELD( 55, STRING  , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, stats_dfu, stats_motiondrops, 0),
    PB_FIELD( 56, UINT32  , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, CapturedAtDate, stats_dfu, 0),
    PB_FIELD( 57, UINT32  , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, CapturedAtTime, CapturedAtDate, 0),
    PB_FIELD( 58, UINT32  , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, CapturedAtOffset, CapturedAtTime, 0),
    PB_FIELD( 59, UINT32  , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, stats_oneshot_seconds, CapturedAtOffset, 0),
