...
const pb_field_t ttproto_Telecast_fields[101] = {
    ...
    PB_FIELD( 54, UINT32  , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, stats_motionevents, stats_iccid, 0),
    PB_FIELD( 55, STRING  , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, stats_dfu, stats_motionevents, 0),
