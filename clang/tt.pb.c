...
const pb_field_t ttproto_Telecast_fields[101] = {
    ...
    PB_FIELD( 73, BOOL    , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, DEPRECATED2017MARmotion, stats_module_lora, 0),
    PB_FIELD( 74, BOOL    , OPTIONAL, STATIC  , OTHER, ttproto_Telecast, test, DEPRECATED2017MARmotion, 0),
