...
/* Generated by nanopb-0.3.5 at Tue Feb 14 10:47:54 2017. */
...
const pb_field_t teletype_Telecast_fields[71] = {
    PB_FIELD(  1, UENUM   , REQUIRED, STATIC  , FIRST, teletype_Telecast, DeviceType, DeviceType, 0),
    PB_FIELD(  2, STRING  , OPTIONAL, CALLBACK, OTHER, teletype_Telecast, DEPRECATED2017FEBDeviceIDString, DeviceType, 0),
    PB_FIELD(  3, UINT32  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, DeviceID, DEPRECATED2017FEBDeviceIDString, 0),
    PB_FIELD(  4, STRING  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, Message, DeviceID, 0),
    PB_FIELD(  5, STRING  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, CapturedAt, Message, 0),
    PB_FIELD(  6, UENUM   , OPTIONAL, STATIC  , OTHER, teletype_Telecast, ReplyType, CapturedAt, 0),
    PB_FIELD(  7, UINT32  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, DEPRECATED2017FEBValue, ReplyType, 0),
    PB_FIELD(  8, FLOAT   , OPTIONAL, STATIC  , OTHER, teletype_Telecast, Latitude, DEPRECATED2017FEBValue, 0),
    PB_FIELD(  9, FLOAT   , OPTIONAL, STATIC  , OTHER, teletype_Telecast, Longitude, Latitude, 0),
    PB_FIELD( 10, INT32   , OPTIONAL, STATIC  , OTHER, teletype_Telecast, Altitude, Longitude, 0),
    ...
    PB_FIELD( 21, UINT32  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, lnd_7318u, RelayDevice5, 0),
    PB_FIELD( 22, UINT32  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, lnd_7128ec, lnd_7318u, 0),
    PB_FIELD( 23, UINT32  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, stats_uptime_minutes, lnd_7128ec, 0),
    ...
    PB_FIELD( 53, STRING  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, stats_iccid, BatteryCurrent, 0),
    PB_FIELD( 54, UINT32  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, stats_motiondrops, stats_iccid, 0),
    ...
    PB_FIELD( 60, UINT32  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, stamp, stats_oneshot_seconds, 0),
    PB_FIELD( 61, UINT32  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, stamp_version, stamp, 0),
    PB_FIELD( 62, STRING  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, stats_cpsi, stamp_version, 0),
    PB_FIELD( 63, UINT32  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, stats_uptime_days, stats_cpsi, 0),
    PB_FIELD( 64, STRING  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, stats_device_label, stats_uptime_days, 0),
    PB_FIELD( 65, STRING  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, stats_gps_params, stats_device_label, 0),
    PB_FIELD( 66, STRING  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, stats_service_params, stats_gps_params, 0),
    PB_FIELD( 67, STRING  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, stats_ttn_params, stats_service_params, 0),
    PB_FIELD( 68, STRING  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, stats_sensor_params, stats_ttn_params, 0),
    PB_FIELD( 69, UINT32  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, lnd_7318c, stats_sensor_params, 0),
    PB_FIELD( 70, STRING  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, stats_battery, lnd_7318c, 0),
    PB_LAST_FIELD
};
