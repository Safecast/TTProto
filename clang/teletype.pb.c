...
const pb_field_t teletype_Telecast_fields[14] = {
    ...
    PB_FIELD( 11, DOUBLE  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, BatteryVoltage, Altitude, 0),
    PB_FIELD( 12, DOUBLE  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, BatterySOC, BatteryVoltage, 0),
    PB_FIELD( 13, DOUBLE  , OPTIONAL, STATIC  , OTHER, teletype_Telecast, WirelessSNR, BatterySOC, 0),
    PB_LAST_FIELD
};
