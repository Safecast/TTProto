...
type Telecast struct {
	...
	ReplyType                       *TelecastReplyType  `protobuf:"varint,6,opt,name=ReplyType,enum=ttproto.TelecastReplyType" json:"ReplyType,omitempty"`
...
var fileDescriptor0 = []byte{
	...
	,
}
